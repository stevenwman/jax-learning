...
# Curriculum-specific logging moved to jax_rl/envs/locomotion/curriculum_logging.py
# (B5.6, 2026-04-25). Re-exported here for backwards compatibility — but new
# code should import from the locomotion module.
from jax_rl.envs.locomotion.curriculum_logging import (  # noqa: E402, F401
    TERRAIN_TYPE_NAMES,
    log_terrain_metrics,
    log_terrain_image,
    print_curriculum_dump,
)
