...
class WarpJoystick(go2_warp_base.Go2WarpEnv):
    ...
    def reset(self, rng: jax.Array) -> mjx_env.State:
        ...
        info = {
            ...
            # Virtual-mass ẍ state: previous control-step foot velocity + the
            # EMA-smoothed ẍ, both (4,3), updated inside VarImpedanceMass.apply.
            "last_foot_vel": jp.zeros((4, 3)),
            "xdd_ema": jp.zeros((4, 3)),
    ...
    def step(self, state: mjx_env.State, action: jax.Array) -> mjx_env.State:
        ...
        # NOTE: last_foot_vel / xdd_ema are updated INSIDE VarImpedanceMass.apply
        # (start-of-step), NOT here — storing post-control made the ẍ finite diff
        # always 0 (v_now==last_foot_vel) → dead mass term.
