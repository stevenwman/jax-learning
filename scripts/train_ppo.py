...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--resume", type=str, default=None,
                        help="Warm-start from checkpoint directory: restores weights + opt state + "
                             "norm state. Replay buffer is NOT persisted; refilled with loaded "
                             "policy actions per --resume-warmup. Not exact training continuation.")
