...
=== "PPO"
    ...
    | Go2WarpJoystickFlatPhysicalMudDR4xSlowFirm | 4,096 | 100M | 3e-04 | 20 | 4 | 0.01 | gamma=0.97, num_updates_per_batch=4, policy_hidden_dim=(512, 256, 128), value_hidden_dim=(512, 256, 128), max_grad_norm=1, eval_every_n_episodes=500, reset_mode=per_step |
    ...
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowFirmRMA | 4,096 | 100M | 3e-04 | 20 | 4 | 0.01 | gamma=0.97, num_updates_per_batch=4, policy_hidden_dim=(512, 256, 128), value_hidden_dim=(512, 256, 128), max_grad_norm=1, eval_every_n_episodes=500, reset_mode=per_step |
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowSlip | 4,096 | 100M | 3e-04 | 20 | 4 | 0.01 | gamma=0.97, num_updates_per_batch=4, policy_hidden_dim=(512, 256, 128), value_hidden_dim=(512, 256, 128), max_grad_norm=1, eval_every_n_episodes=500, reset_mode=per_step |
...
=== "SAC"
    ...
    | Go2WarpJoystickFlatPhysicalMudDR4xSlowFirm | 128 | 5M | 0.001 | 512 | 8 | eval_every_n_episodes=500, reset_mode=per_step |
    ...
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowFirmRMA | 128 | 5M | 0.001 | 512 | 8 | eval_every_n_episodes=500, reset_mode=per_step |
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowSlip | 128 | 5M | 0.001 | 512 | 8 | eval_every_n_episodes=500, reset_mode=per_step |
...
=== "TD3"
    ...
    | Go2WarpJoystickFlatPhysicalMudDR4xSlowFirm | 128 | 5M | 3e-04 | 256 | 4 | eval_every_n_episodes=500, reset_mode=per_step |
    ...
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowFirmRMA | 128 | 5M | 3e-04 | 256 | 4 | eval_every_n_episodes=500, reset_mode=per_step |
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowSlip | 128 | 5M | 3e-04 | 256 | 4 | eval_every_n_episodes=500, reset_mode=per_step |
...
=== "FastTD3"
    ...
    | Go2WarpJoystickFlatPhysicalMudDR4xSlowFirm | 1,024 | 100M | 3e-04 | 8,192 | 8 | gamma=0.97, noise_min=0.01, noise_max=0.05, eval_every_n_episodes=500, reset_mode=per_step |
    ...
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowFirmRMA | 1,024 | 100M | 3e-04 | 8,192 | 8 | gamma=0.97, noise_min=0.01, noise_max=0.05, eval_every_n_episodes=500, reset_mode=per_step |
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowSlip | 1,024 | 100M | 3e-04 | 8,192 | 8 | gamma=0.97, noise_min=0.01, noise_max=0.05, eval_every_n_episodes=500, reset_mode=per_step |
...
=== "FastSAC"
    ...
    | Go2WarpJoystickFlatPhysicalMudDR4xSlowFirm | 1,024 | 100M | 3e-04 | 8,192 | 8 | gamma=0.97, eval_every_n_episodes=500, reset_mode=per_step |
    ...
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowFirmRMA | 1,024 | 100M | 3e-04 | 8,192 | 8 | gamma=0.97, eval_every_n_episodes=500, reset_mode=per_step |
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowSlip | 1,024 | 100M | 3e-04 | 8,192 | 8 | gamma=0.97, eval_every_n_episodes=500, reset_mode=per_step |
...
=== "FlashSAC"
    ...
    | Go2WarpJoystickFlatPhysicalMudDR4xSlowFirm | 1,024 | 100M | 3e-04 | 2,048 | 8 | gamma=0.97, eval_every_n_episodes=500, reset_mode=per_step |
    ...
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowFirmRMA | 1,024 | 100M | 3e-04 | 2,048 | 8 | gamma=0.97, eval_every_n_episodes=500, reset_mode=per_step |
    | Go2WarpOscVarDampingAxisFlatPhysicalMudDR4xSlowSlip | 1,024 | 100M | 3e-04 | 2,048 | 8 | gamma=0.97, eval_every_n_episodes=500, reset_mode=per_step |
